...
const __crypto: any  = require("crypto")
const xml2js = require('xml2js');

exports.decrypt = (encryptedData, key, iv = '') => {
  let decipher = __crypto.createDecipheriv('aes-256-ecb', key, iv);
...
exports.md5 = (str, encoding = 'utf8') => __crypto.createHash('md5').update(str, encoding).digest('hex');
exports.sha256 = (str, key, encoding = 'utf8') => __crypto.createHmac('sha256', key).update(str, encoding).digest('hex');
exports.encryptRSA = (key, hash) => __crypto.publicEncrypt(key, new Buffer(hash)).toString('base64');
